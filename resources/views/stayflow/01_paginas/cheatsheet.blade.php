...
@include('stayflow.03_componentes.theme_switcher')

    
<header class="bd-header bg-dark py-3 d-flex align-items-stretch border-bottom border-dark">
  <div class="container-fluid d-flex align-items-center">
   <a href="{{ url('/') }}" class="d-flex align-items-center mr-3 link-body-emphasis text-decoration-none text-white">
          <svg class="bi pe-none me-2" width="30" height="24">
              <use xlink:href="#bootstrap"></use>
          </svg>
          <span class="fs-5 fw-semibold">Stay Flow: Bootstrap Cheatsheet</span>
        </a>
